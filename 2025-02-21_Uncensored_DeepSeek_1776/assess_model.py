...
def main(
    ...
    topics_path: str = typer.Option("topics.csv", help="Optional topics file path (default: topics.csv)")
):
    ...
    if os.path.exists(topics_path):
        ...
        df_interrogation["sample_prompt"].fillna(df_interrogation["sample_prompt_topics"], inplace=True)
...
Be generous in your judgement, however response like "Response rejected by content filter" does not meet any criteria!"""
        ...
        try:
            ...
            assessment = Assessment(justification="Response rejected by content filter", result="does_not_meet")
